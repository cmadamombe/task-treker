...
class AddTodoForm(ModelForm):  # inherits from ModelForm.
    ...
    description = forms.CharField(required=True, disabled=False,
                                  widget=forms.Textarea(attrs={'rows': 7, 'cols': 6}))
...
class UpdateTodoForm(ModelForm):  # inherits from ModelForm.
    ...
    description = forms.CharField(required=False, disabled=False, widget=forms.Textarea(attrs={'rows': 7, 'cols': 6}))
    ...
    datecompleted = forms.DateField(required=False)
